document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width = `${(quiz.currentQuestionIndex + 1 / questions.length) * 100}%`


    // 3. Update the question count text 
    // Update the question count (div#questionCount) show the current question out of total questions
    questionCount.innerHTML = `Question ${quiz.currentQuestionIndex + 1} of ${questions.length}`
    ...
    */
    question.choices.forEach((eachChoice) => {
      ...
      radioButton.innerHTML = eachChoice
