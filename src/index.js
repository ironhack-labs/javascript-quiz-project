document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width = `${(quiz.currentQuestionIndex + 1) *(100 / questions.length)}%`; // This value is hardcoded as a placeholder
...
console.log(quiz);
    ...
    questionCount.innerText = `Question ${quiz.currentQuestionIndex + 1} out of ${questions.length}`; //  This value is hardcoded as a placeholder
console.log(quiz)
