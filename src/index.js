document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    */
    ...
    choicesArray.forEach(element => {
      ...
      choiceButton.name = 'name';
      choiceButton.value = 'value';
      const choiceButtonLabel = document.createElement('label')
      choiceButtonLabel.setAttribute('for', 'value')
      choiceButtonLabel.innerText = [element]
      const lineBreak = document.createElement('br')
      choiceContainer.appendChild(choiceButton)
      choiceContainer.appendChild(choiceButtonLabel)
  ...
  function nextButtonHandler() {
    ...
    const selectedAnswerText = quiz.getQuestion().choices[selectedAnswer];
    ...
    quiz.checkAnswer(selectedAnswerText);
