document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    questionContainer.innerText = quiz.getQuestion().text;
    ...
    const arrAnswers = quiz.getQuestion().choices;

    // arrAnswers.forEach((answerElement) => {
    //  console.log(answerElement)
    //   choiceContainer.innerHTML += `
    //     <input type="radio" name="choice" value="${answerElement}">
    //       <label>${answerElement}</label>
    //     <br>`;
    // });
    ...
    arrAnswers.forEach((answerElement) => {
      ...
      inputField.name = "choices";
      inputField.value = answerElement;

      let label = document.createElement("label");
      label.innerText = answerElement;
      ...
      //place
      choiceContainer.appendChild(inputField);
