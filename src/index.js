document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    quiz.questions[quiz.currentQuestionIndex].choices.forEach(function (
      choice
    ) {
      const questionChoice = document.createElement("div");
      questionChoice.innerHTML = `<input type="radio" name="choice" value="${choice}">
        <label>${choice}</label>
      <br>`;
      choiceContainer.appendChild(questionChoice);
    });
  }
  ...
  function nextButtonHandler() {
    ...
    choiceElements.forEach(function (input) {
      if (input.checked) {
