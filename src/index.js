document.addEventListener("DOMContentLoaded", () => {
  ...
  const countdown = setInterval(() => {
    ...
    if (quiz.timeRemaining === 0) {
      clearInterval(quiz.timeRemaining);
    }
    quiz.timeRemaining--;
  }, 1000); */
  ...
  function showQuestion() {
    ...
    if (quiz.hasEnded()) {
      showResults();
      //clear the time interval to stop the timer
      clearInterval(timer);
    ...
    progressBar.style.width = `${answeredQuestion}%`; // This value is hardcoded as a placeholder
    ...
    questionCount.innerText = questionCountText; //  This value is hardcoded as a placeholder
