document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    console.log(questionText.innerHTML = question.text);


    // 2. Update the green progress bar
    // Update the green progress bar (div#progressBar) width so that it shows the percentage of questions answered

    let answeredQuestions = quiz.currentQuestionIndex / quiz.questions.length;


    progressBar.style.width = `${100 * answeredQuestions}%`; // This value is hardcoded as a placeholder
    ...
    question.choices.forEach((choice) => {
      ...
      let radioChoice = document.createElement("li");

      radioChoice.innerHTML = `
  ...
  function nextButtonHandler() {
    ...
    const allChoiceElements = document.querySelectorAll("input[name=choice]")
    ...
    allChoiceElements.forEach((choice) => {
