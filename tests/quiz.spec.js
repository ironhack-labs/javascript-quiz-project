describe("Quiz", () => {
  ...
  describe("filterQuestionsByDifficulty() method", () => {
    ...
    it("should be defined", () => {
      ...
      expect(myQuiz1.filterQuestionsByDifficulty).toBeDefined();
    });
    ...
    it("should be a function", () => {
      ...
      expect(typeof myQuiz1.filterQuestionsByDifficulty).toBe("function");
    });
    ...
    it("should receive 1 argument (difficulty)", () => {
      ...
      expect(myQuiz1.filterQuestionsByDifficulty.length).toEqual(1);
    });
    ...
    it("should update the 'questions' array with the questions filtered by difficulty", () => {
      ...
      myQuiz1.filterQuestionsByDifficulty(3);
      // 4. Check if the questions array has been filtered correctly
      expect(myQuiz1.filterQuestionsByDifficulty(3)).toEqual([
        {
          text: "Question 4",
          choices: ["j", "k", "l"],
          answer: "j",
    ...
    it("should not change the 'questions' array if the 1st argument is not a number between 1 and 3", () => {
      ...
      myQuiz1.filterQuestionsByDifficulty("a");
      // 4. Check if the questions array is still the same as the original (it hasn't been filtered)
      expect(myQuiz1.filterQuestionsByDifficulty("a")).toEqual(questions)
    });
  });
  ...
  describe("averageDifficulty() method", () => {
    ...
    it("should be defined", () => {
      ...
      //
      // 1. Instantiate a new Quiz object
      const myQuiz2 = new Quiz(questions, 60, 60)
      // 2. Check if the averageDifficulty() method is defined
      expect(myQuiz2.averageDifficulty).toBeDefined()
    ...
    it("should be a function", () => {
      ...
      expect(typeof myQuiz2.averageDifficulty).toBe("function")
    });
    ...
    it("should receive no arguments", () => {
      ...
      expect(myQuiz2.averageDifficulty.length).toEqual(0);
    });
    ...
    it("should return the average difficulty of the questions in the quiz", () => {
      ...
      expect(myQuiz2.averageDifficulty()).toEqual(1.8)
    });
  });
});
