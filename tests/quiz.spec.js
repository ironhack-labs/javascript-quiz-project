describe("Quiz", () => {
  ...
  describe("filterQuestionsByDifficulty() method", () => {   
    ...
    it("should be defined", () => {
      ...
      expect(quiz.filteredQuestionByDifficulty).toBeDefined();
    });
    ...
    it("should receive 1 argument (c)", () => {
      // YOUR CODE HERE:
      //
      // 1. Instantiate a new Quiz object
      const quiz = new Quiz([], 60, 60);
    ...
    it("should update the 'questions' array with the questions filtered by difficulty", () => {
      ...
      expect(this.filterQuestionsByDifficulty(1)).toEqual(this.questions.push(this.difficulty));
      expect(this.filterQuestionsByDifficulty(2)).toEqual(this.questions.push(this.difficulty));
      expect(this.filterQuestionsByDifficulty(3)).toEqual(this.questions.push(this.difficulty));
    });
